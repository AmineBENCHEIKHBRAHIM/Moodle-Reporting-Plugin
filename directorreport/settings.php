...
$ADMIN->add('reports', new admin_externalpage('reportdirectorreport', get_string('pluginname', 'report_directorreport'), "$CFG->wwwroot/report/directorreport/index.php",'report/directorreport:view'));
