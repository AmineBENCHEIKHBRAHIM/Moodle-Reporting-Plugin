...
require($CFG->dirroot.'/report/directorreport/index_form.php');
// Get the system context.
$systemcontext = context_system::instance();
$url = new moodle_url('/report/directorreport/index.php');
// Check basic permission.
require_capability('report/directorreport:view',$systemcontext);
// Get the language strings from language file.
             
$strgrade = get_string('grade','report_directorreport');
$strcourse = get_string('course','report_directorreport');
$strlastaccess = get_string('directorreport','report_directorreport');
$strname = get_string('name','report_directorreport');
$strtitle = get_string('title','report_directorreport');
// Set up page object.
$PAGE->set_url($url);
...
// Load up the form.
$mform = new directorreport_form('', array('courses' => $courses));
...
echo "<Strong>La liste des Etudiants inactifs Dans ce cours est :</Strong><br>";
  ...
  echo $OUTPUT->single_button("index.php?export=1&cid=$data->currentdate&ld=$data->lastaccesseddate",get_string('exportcsv','report_directorreport'));
}
